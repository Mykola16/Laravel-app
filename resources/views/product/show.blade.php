            ...
            <div class="row details_row">
                ...
                <div class="col-lg-6">
                    <div class="details_image">
                        ...
                        <div class="details_image_large"><img src="/images/{{$image}}" alt="{{$item->name}}">
                            <div class="product_extra product_new"><a href="{{route('showCategory',$item->category['alias'])}}">{{$item->category['name']}}</a></div>
                        </div>
                        ...
                        <div class="in_stock_container">
                            <div class="availability">Availability:</div>
                             @if($item->in_stock)
                                <span>In Stock</span>
                             @else
                                <span style="color: red;">No in stock</span>
                             @endif
